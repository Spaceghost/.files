...
- Implementation: [decoration motion](desktop/.local/lib/mbp_intel/decoration_motion.py),
  ...
  [bounded scheduling helper](bin/mbp-intel-ui-priority).
...
- Implementation: [keyboard light](desktop/.local/bin/mbp-intel-keyboard-backlight),
  [bindings](desktop/.config/sway/local.d/keyboard-backlight.conf),
  [control deck](desktop/.local/bin/mbp-intel-control).
...
- Implementation: [Scripture modules](desktop/.local/lib/mbp_intel/scripture.py),
  [card clicks](desktop/.local/lib/mbp_intel/conky_click.lua),
  [inline search bar](desktop/.local/bin/mbp-intel-scripture-bar),
