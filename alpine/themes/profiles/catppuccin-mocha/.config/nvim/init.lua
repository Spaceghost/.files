...
local palette = {
    bg = "#1e1e2e", hard = "#11111b", soft = "#282839", bg1 = "#313244", bg2 = "#45475a",
    fg = "#cdd6f4", bright = "#d7def6", muted = "#6c7086", red = "#f38ba8", green = "#a6e3a1",
    yellow = "#f9e2af", blue = "#89b4fa", purple = "#cba6f7", aqua = "#94e2d5", orange = "#fab387",
}
