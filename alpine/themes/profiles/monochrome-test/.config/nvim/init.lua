...
local palette = {
    bg = "#000000", hard = "#000000", soft = "#0e0e0e", bg1 = "#000000", bg2 = "#ffffff",
    fg = "#ffffff", bright = "#ffffff", muted = "#ffffff", red = "#ffffff", green = "#ffffff",
    yellow = "#ffffff", blue = "#ffffff", purple = "#ffffff", aqua = "#ffffff", orange = "#ffffff",
}
