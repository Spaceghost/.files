...
local palette = {
    bg = "#13091f", hard = "#0c0514", soft = "#1f152b", bg1 = "#261631", bg2 = "#49315b",
    fg = "#f3e9fa", bright = "#f5edfb", muted = "#816b91", red = "#ff6f91", green = "#8fe3b0",
    yellow = "#dca7ff", blue = "#8ab6ff", purple = "#c48bf0", aqua = "#9fe8ff", orange = "#ffb37a",
}
