...
for name in ['__init__', 'update', 'restyle', 'place', 'handoff', 'destroy']:
...
out = root / 'alpine/verification/animation-fluidity/decoration/construction-reuse-profile'
