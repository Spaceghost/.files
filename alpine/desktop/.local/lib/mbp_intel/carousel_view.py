...
class Popup:
    ...
    def __init__(self, state, modifier, on_command, on_map, output_name=None):
        ...
        self.window.set_name('mbp-intel-carousel')
        ...
        Gtk4LayerShell.set_namespace(self.window, 'mbp-intel-carousel')
        ...
        self.provider.load_from_string('#mbp-intel-carousel { background: transparent; box-shadow: none; }')
