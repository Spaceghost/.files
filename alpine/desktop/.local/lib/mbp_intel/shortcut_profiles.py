"""Curated, deliberately partial shortcut profiles for the MBP Intel desktop.
...
* Neovim: https://neovim.io/doc/user/usr_02.html and the checked-in init.lua
...
PROFILES = {
    ...
    'nvim': {
        ...
        'rows': (
            ...
            ('u / Ctrl+R', 'Undo / redo'),
            ('Space+W / Space+Q', 'Write / quit (local mappings)'),
        ),
    },
    'btop': {
        'name': 'btop',
