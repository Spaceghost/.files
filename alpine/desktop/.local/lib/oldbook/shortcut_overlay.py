...
class SessionLease:
    ...
    def __init__(self, runtime, sway_socket):
        ...
        self.directory = self.runtime / 'oldbook-shortcuts'
...
class GtkShortcutOverlay:
    ...
    def __init__(self):
        ...
        self.window.set_name('oldbook-shortcuts-window')
        ...
        GtkLayerShell.set_namespace(self.window, 'oldbook-shortcuts')
        ...
        self.panel.set_name('oldbook-shortcuts-panel')
    ...
    def _header(self, title):
        ...
        heading.pack_start(self._label(title, 'oldbook-shortcuts-title'), False, False, 0)
        heading.pack_start(self._label(
            'Release Super to close  •  Scroll for more', 'oldbook-shortcuts-hint'),
            False, False, 0)
    ...
    def show_loading(self, context=None):
        ...
        self.panel.pack_start(self._label(
            'Loading the focused context…', 'oldbook-shortcuts-description'),
            False, False, 0)
...
def _run_daemon(runtime, socket_path, profiles_path=None):
    from oldbook.shortcut_hold import EvdevMonitor
