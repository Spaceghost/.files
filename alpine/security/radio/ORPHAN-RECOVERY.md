...
9. A different boot ID currently refuses recovery before signaling or kernel/DNS cleanup. A conservative resolver/record completion fallback across boots is not implemented; it needs a separate design and proof.
