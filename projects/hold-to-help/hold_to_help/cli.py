"""Hold to Help: hold a configured key to view contextual shortcuts."""
import argparse
...
def parse_args(arguments=None):
    ...
    parser.add_argument('--version', action='version', version=f'Hold to Help {__version__}')
...
def preview(socket_path, profiles_path=None, seconds=5.0, *, backend='sway',
    ...
    application = create_application(['hold-to-help'])
    ...
    with ExitStack() as resources:
        ...
        def tick():
            ...
            try:
                ...
                print(f'hold-to-help: {error}', file=sys.stderr)
                application.exit(1)
