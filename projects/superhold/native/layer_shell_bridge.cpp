...
extern "C" Q_DECL_EXPORT int superhold_layer_shell_prepare()
{
...
extern "C" Q_DECL_EXPORT int superhold_layer_shell_configure(
    void *window_pointer, void *screen_pointer, int width, int height, int top_margin)
{
    ...
    layer->setScope(QStringLiteral("superhold"));
...
// Deprecated C ABI names for previously built local callers.
extern "C" Q_DECL_EXPORT int hth_layer_shell_prepare()
{
    return superhold_layer_shell_prepare();
}

extern "C" Q_DECL_EXPORT int hth_layer_shell_configure(
    void *window_pointer, void *screen_pointer, int width, int height, int top_margin)
{
    return superhold_layer_shell_configure(
        window_pointer, screen_pointer, width, height, top_margin);
}
