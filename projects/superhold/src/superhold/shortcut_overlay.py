...
class GtkShortcutOverlay:
    ...
    #superhold-title { color: #f2d5e8; font-size: 22px; font-weight: bold; }
    #superhold-hint { color: #a89984; font-size: 11px; }
    #superhold-section {
        background-color: rgba(60, 42, 77, 0.82);
        border-radius: 10px;
        padding: 12px;
    }
    #superhold-section-title { color: #d3869b; font-size: 15px; font-weight: bold; }
    #superhold-coverage { color: #a89984; font-size: 10px; }
    #superhold-key {
    ...
    #superhold-description { color: #ebdbb2; }
    scrollbar slider { background-color: #b16286; min-width: 8px; min-height: 28px; }
    '''

    def __init__(self, preview_seconds=None):
        import gi
